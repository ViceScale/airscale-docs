...
- Use the read-only documentation MCP at https://airscale.mintlify.app/mcp only to search and retrieve documentation. It does not execute Airscale product tools or consume Airscale credits.
