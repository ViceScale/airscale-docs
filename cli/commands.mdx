...
description: "Every Airscale CLI 0.2.1 command and flag for setup, authentication, completion, search, file enrichment, credits, and runs."
...
See [upgrade instructions](/cli/troubleshooting#upgrade-to-0-2-1) before using a saved global installation.
