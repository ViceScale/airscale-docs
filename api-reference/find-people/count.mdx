---
title: "Count people"
description: "Count people matching person, role, and company filters. Rate limit: 6 requests per second per workspace."
...
<Note>
Count is free. It neither reserves nor debits Airschool credits, and its response contains only the matching total.
</Note>
