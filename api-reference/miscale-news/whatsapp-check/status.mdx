...
description: "Reconcile a WhatsApp check using its operation ID. Rate limit: No endpoint-specific GET throttle."
canonical: "https://airscale.mintlify.app/api-reference/miscale-news/whatsapp-check/status"
