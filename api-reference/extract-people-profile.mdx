...
const url = "https://api.airscale.io/v1/profile";
...
```php
<?php
$apiUrl = "https://api.airscale.io/v1/profile";
...
func main() {
	body := []byte(`{"linkedin_profile_url":"https://linkedin.com/in/vdetraz"}`)
	req, _ := http.NewRequest("POST", "https://api.airscale.io/v1/profile", bytes.NewBuffer(body))
