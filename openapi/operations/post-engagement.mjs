...
const errorDescriptions = {
  400: "The JSON body, LinkedIn post URL, cursor, or Idempotency-Key is invalid.",
  402: "The workspace does not have enough credits to reserve profile enrichment for this page.",
  409: "The Idempotency-Key is already in progress or was reused with a different request.",
