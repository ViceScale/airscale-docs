...
const findPeopleFilterDescriptions = {
  ...
  pastJobTitle: "Matches a title in a previous position. All past-experience filters must match the same prior role.",
  pastCompanyName: "Matches a previous company name. All past-experience filters must match the same prior role.",
